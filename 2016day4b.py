...
for code in codes:
    ...
    letterIncrease = sectorID % 26
    RoomName = code[:endCode-4]

    newWord = ''
    for c in RoomName:
        if c == '-':
            newLetter = ' '
        elif ord(c) + letterIncrease > ord('z'):
            newLetter = chr(ord(c)+letterIncrease-26)
        else:
            newLetter = chr(ord(c)+letterIncrease)
